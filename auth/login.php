...
<head>
  ...
  <style>
    ...
    .container {
      ...
      padding: 30px;
      color: #333333; /* Text color inside container */
    }
    ...
    .text-secondary {
      color: #6c757d; /* Gray for secondary text */
    }
  </style>
</head>
...
<body class="d-flex flex-column min-vh-100" data-bs-theme="dark">
  <div class="container my-5 animate__animated animate__fadeIn">
    <h1 class="mb-4 text-center animate__animated animate__bounceIn">Login</h1>
    <form action="" method="post" class="needs-validation border p-2-md p-5 rounded animate__animated animate__zoomIn" novalidate>
      <div class="mb-3">
